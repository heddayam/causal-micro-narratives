...
def run_dspy(dev_ds, test_ds, model, fewshot=False):
    if model == 'claude':
        os.environ['ANTHROPIC_API_KEY'] = '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'
        ...
        os.environ['OPENAI_API_KEY'] = "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"

...
def init_llm(model):
    ...
    if model.startswith('gpt') or model.startswith('o1'):
        ...
        openai.api_key = "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"
        cache = OpenAIAPICache(mode="chat", port=redis_port)
    elif model.startswith('claude'):
        from src.utils.llm_cache import ClaudeAPICache
        anthropic_client = anthropic.Anthropic(api_key="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")

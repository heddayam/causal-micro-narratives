...
torchrun --nproc_per_node=4 --master_port=45283 /net/scratch/mourad/economic-narratives/src/finetune/phi2_binary_sft_train.py \
   --model_name_or_path microsoft/phi-2 \
    --model_max_length 2048 \
    --data_path /net/projects/chai-lab/mourad/narratives-data/sft_data \
    --output_dir /net/projects/chai-lab/mourad/narratives-data/sft_out/phi2_binary \
    --max_steps 300 \
    ...
    --tf32 True \
    --run_name "phi2_binary_500steps_${1}" \
